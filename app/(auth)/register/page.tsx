  ...
  return (
    ...
    >
      ...
      <motion.div variants={item} className="mb-8">
        <p className="text-xs font-bold tracking-[0.25em] uppercase text-[#e6a020]/60 mb-2">Bergabung Sekarang</p>
        <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight" style={{
          background: "linear-gradient(135deg, #1a1a1a 0%, #4a4a4a 100%)",
          WebkitBackgroundClip: "text",
          WebkitTextFillColor: "transparent",
        }}>Daftar Akun</h2>
        <p className="text-gray-400 mt-2 text-sm font-medium">Mulai kembangkan UMKM kamu bersama LokaKarya.</p>
      </motion.div>
      ...
      <form className="space-y-4">
          ...
          <div className="relative">
            <input
              ...
              onFocus={e => {
                ...
                e.target.style.border = "1.5px solid rgba(230,160,32,0.4)";
                e.target.style.boxShadow = "0 4px 20px rgba(230,160,32,0.12), inset 0 1px 2px rgba(0,0,0,0.02)";
              }}
              onBlur={e => {
                e.target.style.background = "rgba(255,255,255,0.7)";
                e.target.style.border = "1.5px solid rgba(0,0,0,0.07)";
                e.target.style.boxShadow = "0 2px 8px rgba(0,0,0,0.04), inset 0 1px 2px rgba(0,0,0,0.03)";
              }}
            />
          </div>
        </motion.div>
        ...
        <motion.div variants={item} className="group">
          ...
          <input
            type="password"
            placeholder="Sesuaikan kata sandi"
            className="w-full rounded-2xl px-5 py-3.5 text-sm text-gray-800 outline-none transition-all"
            style={{
              background: "rgba(255,255,255,0.7)",
              border: "1.5px solid rgba(0,0,0,0.07)",
        ...
        <motion.div variants={item} className="flex items-center gap-3 py-1">
          <input type="checkbox" id="terms" className="w-4 h-4 rounded accent-[#e6a020] cursor-pointer" />
          <label htmlFor="terms" className="text-xs text-gray-400 font-medium cursor-pointer">
            Saya setuju dengan{" "}
            <span className="text-[#e6a020] font-bold">Syarat & Ketentuan</span>
          </label>
        </motion.div>
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.99 }}
          className="w-full text-white py-4 rounded-2xl font-bold text-base mt-1 transition-all"
          style={{
            background: "linear-gradient(135deg, #e6a020 0%, #f0b830 50%, #e6a020 100%)",
            boxShadow: "0 10px_30px -6px rgba(230,160,32,0.45), inset 0 1px 0 rgba(255,255,255,0.2)",
          }}
        >
          Buat Akun Sekarang
        </motion.button>
      ...
      {/* Footer */}
      <motion.p variants={item} className="mt-7 text-center text-gray-400 text-sm font-medium">
        Sudah punya akun?{" "}
        <Link href="/login" className="text-[#e6a020] font-extrabold hover:underline">
          Masuk di sini
        </Link>
      </motion.p>
    </motion.div>
